...
from GUI.Measure import Ui_MainWindow
...
class MyForm(QMainWindow):
    ...
    def __init__(self, parent = None):
        ...
        self.connect(self.ui.selectVisaButton, SIGNAL("clicked()"), self.select_visa)
        self.connect(self.ui.updateVisaButton, SIGNAL("clicked()"), self.update_visa)
        ...
        self.connect(self.ui.sendButton, SIGNAL("clicked()"), self.send)
        self.connect(self.action_timer, SIGNAL("timeout()"), self.action)
        
        self.connect(self.ui.input, SIGNAL("returnPressed()"), self.send)
        self.connect(self.ui.upButton, SIGNAL("clicked()"), self.up)
        self.connect(self.ui.downButton, SIGNAL("clicked()"), self.down)
        self.connect(self.ui.quitButton, SIGNAL("clicked()"), self.close)
        self.connect(self.ui.zeroButton, SIGNAL("clicked()"), self.zero)
        self.connect(self.ui.closeVisaButton, SIGNAL("clicked()"), self.close_visa)
